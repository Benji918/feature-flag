...
Thin wrapper around backend/test_schema.py -- it runs that suite and nothing
else. The assertions (EXPECTED_COLUMNS, round-trips, uniqueness, RESTRICT,
FK checks) live in ONE place, test_schema.py, so a future schema change is
made once and both entry points stay in agreement by construction.
